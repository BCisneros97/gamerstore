<div class="permisos index">
	...
	<tr>
		...
		<td><?php echo h($permiso['Permiso']['descripcion']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $permiso['Permiso']['id']), array(), __('Are you sure you want to delete # %s?', $permiso['Permiso']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
