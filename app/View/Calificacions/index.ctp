<div class="calificacions index">
	<h2><?php echo __('Calificacions'); ?></h2>
	...
	<tr>
		...
		<td><?php echo h($calificacion['Calificacion']['calificacion']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $calificacion['Calificacion']['id']), array(), __('Are you sure you want to delete # %s?', $calificacion['Calificacion']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
