                    ...
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <?php foreach ($ciudads as $ciudad) : ?>
                            <tr>
                                ...
                                <td><?php echo h($ciudad['Region']['nombre']);?></td>
                                <td>
                                    <div class="btn-group">
                                        <?php echo $this->Html->link(
                                            $this->Html->tag(
                                            ...
                                            array('action' => 'view', $ciudad['Ciudad']['id']),
                                            array('escape' => false)
                                        ); ?>
                                        <?php echo $this->Html->link(
                                            $this->Html->tag(
                                            ...
                                            array('action' => 'edit', $ciudad['Ciudad']['id']),
                                            array('escape' => false)
                                        ); ?>
                                        <?php echo $this->Form->postLink(
                                            ...
                                            array('escape' => false),
                                            __('¿Está seguro de que quiere eliminar "%s"?', $ciudad['Ciudad']['nombre'])
                                        ); ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
