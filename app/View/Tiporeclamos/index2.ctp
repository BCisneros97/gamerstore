<div class="tiporeclamos index">
	<h2><?php echo __('Tiporeclamos'); ?></h2>
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $tiporeclamo['Tiporeclamo']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $tiporeclamo['Tiporeclamo']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $tiporeclamo['Tiporeclamo']['id']), array(), __('Are you sure you want to delete # %s?', $tiporeclamo['Tiporeclamo']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
